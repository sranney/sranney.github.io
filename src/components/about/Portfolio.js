...
const currTech = [
    {
        ...
        subcontent: [
            ...
            {
                content: 'This site was written in some of the technologies that I have been enjoying learning the most right now. Within it, I am using a whooooole bunch of React related technologies! 🎊🥳🍻',
                type: 'description',
                key: 'descr-portf'
            },
            {

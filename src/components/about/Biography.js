	...
	return (
		<div>
			<PostBody>
				...
				<CenteredContentWrapper>
					<InViewImage loader caption='The students that I worked with as a teaching assistant in the bootcamp. One of the biggest privileges of my life was to be a part of their journey. I learned so much from working with them.' imgSrc='http://mylearningposts-api.herokuapp.com/images/bootcamp-grads.jpeg' />
				</CenteredContentWrapper>
				<PostSectionHeader>

...
import {
  StyledAnchor
} from "../../helpers/styled-components/links";
...
const referencesArr = [
  ...
  },
  {
    ...
    role:
      "Director, Software Engineering - Partner Programs at Dealer.com, A Cox Automotive Company",
    words:
      "Spencer has been a fantastic team member! His professionalism, work ethic, and reliability have been a key contributor to the success we've experienced as an organization. He's a great teacher and not afraid of any challenge. I highly recommend Spencer!"
  },
  {
    key: 1234,
    author: "Jon Lynch",
  ...
  },
  {
    ...
    words:
      "Spencer is very passionate about learning and teaching new technologies. I really like working with him. He is an amazing team member, who is always willing to help others. He has a very deep understanding of React and Redux. He is a valuable asset to have on any team."
  },
  {
    key: 3,
    author: "Saif Khaled",
  ...
  },
  {
    ...
    words:
      "Spencer is an attentive, mindful, knowledgeable, hungry developer. Any time I had a question, Spencer could always answer it or would find the answer super fast. He knows how to analyze and approach problems quite well. I would jump at any chance to work with him now and in the future."
  },
  {
    key: 239402,
    ...
    words:
      "Spencer is extremely intelligent and a well versed engineer. His passion for new technology is evident in his everyday conversations. His humility and willingness to help others has made him one of the most desirable team members to work with."
  },
  {
    key: 2930,
    author: "Lacy Harris",
  ...
  },
  {
    ...
    words:
      "Spencer was invaluable as the teaching assistant in my class at SMU’s Coding Bootcamp program. He proved himself as a knowledgable JavaScript expert who was personable, willing to support students, and able to help us problem solve. I credit him with helping to motivate and inspire me to complete the SMU Bootcamp and launch my new career"
  },
  {
    key: 13,
    ...
    words:
      "I am one of the fortunate students who have Spencer as a Teacher's Assistant during my experience in the SMU Coding Boot Camp. Spencer is always willing to help; when called upon, he has a great way of guiding a person towards identifying their issue and solving the problem instead of doing the work for them. He is eager to share his knowledge of Web Development, as well as new technologies he is learning. I consider Spencer a valuable resource, and am glad to have him as someone I can call upon in my time of need."
  },
  {
    key: 14,
...
export default function References() {
  return (
    <PostBody>
      ...
      <PostPar>
        I have had the good fortune of forming some really great work
        relationships in my career . I feel blessed to have these people in my
        life. Here&apos;s what some of them have to say about me.{" "}
      </PostPar>
      <StyledAnchor
        size="xlarge"
        href="https://www.linkedin.com/in/spencer-ranney/"
        target="_blank"
      >
        Check out my LinkedIn profile
      </StyledAnchor>
      {referencesArr.map(({ key, author, role, words, linkedin }) => {
        return (
          <SlideInViewContainer key={key}>
            <div className="feature">
              <span className="primary">{author}</span>
              <span className="secondary">{role}</span>
              <span className="reference">
                <StyledAnchor size="large" href={linkedin} target="_blank">
                  LinkedIn
                </StyledAnchor>
              </span>
            </div>
            <div className="content">
              <span className="tertiary">{words}</span>
            </div>

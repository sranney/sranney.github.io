...
import {PostBody, FlexContainer} from "../helpers/styled-components/containers";
...
export default function About() {
    return (
        <PostBody>
            ...
            <FlexContainer>
                <InViewImage loader imgSrc="http://mylearningposts-api.herokuapp.com/images/me-in-tux.jpg"/>
            </FlexContainer>
            <PostPar>
                While I believe my posts here will speak clearly about who I am as an engineer and what my philosophy of engineering is, there's a lot more to who I am than that. So let me tell you a little bit about who I am, some engineering principals I enjoy the most, and where I got started.
            </PostPar>
            <PostSectionHeader>
            ...
            <FlexContainer>
                <InViewImage loader imgSrc="http://mylearningposts-api.herokuapp.com/images/Austin-1990.jpg" />
            </FlexContainer>            
            <PostPar>
            ...
            <FlexContainer>
                <InViewImage loader imgSrc="http://mylearningposts-api.herokuapp.com/images/bootcamp-grads.jpeg" />
            </FlexContainer>
            <PostSectionHeader>
            ...
            <PostPar>
                I have formed a reputation for being not only knowledgeable in these topics, but also being a good teacher. I am involved in many processes of teams applying the aforementioned technologies and several more. On an individual basis, I sit with developers and help them learn different topics in technologies.
            </PostPar>
            <PostPar>
            ...
            <FlexContainer>
                <InViewImage loader imgSrc="http://mylearningposts-api.herokuapp.com/images/me-in-squamish.jpg" />
            </FlexContainer>
            <PostSectionHeader>
